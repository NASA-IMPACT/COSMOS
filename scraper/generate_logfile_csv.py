...
def load_logfile(logfile_path="base_spider.log"):
...
def save_csv(processed_log_file):
    with open("base_spider.csv", "w") as csv_file:
        writer = csv.writer(csv_file, delimiter=",")
        for line in processed_log_file:
            writer.writerow(line)


def process_logfile_and_generate_csv():
    """
